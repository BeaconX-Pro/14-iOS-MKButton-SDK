...
- (NSInteger)loadNumberOfRows:(NSInteger)section {
    if (section == 0) {
        if (self.dataModel.dismissAlarmNotiType == 1 || self.dataModel.dismissAlarmNotiType == 3) {
            //LED/LED+Buzzer
    ...
    if (section == 2) {
        if (self.dataModel.dismissAlarmNotiType == 2 || self.dataModel.dismissAlarmNotiType == 3) {
            //Buzzer/LED+Buzzer
