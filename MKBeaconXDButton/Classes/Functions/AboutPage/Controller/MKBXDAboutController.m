...
@interface MKBXDAboutController ()
...
@implementation MKBXDAboutController

- (void)dealloc {
    NSLog(@"MKBXDAboutController销毁");
}
...
- (void)loadSubViews {
    ...
    UIImage *image = LOADICON(@"MKBeaconXDButton", @"MKBXDScanController", @"bxd_aboutBottomIcon.png");
...
- (UILabel *)appNameLabel{
    if (!_appNameLabel) {
        ...
        _appNameLabel.text = @"MOKO BUTTON";
    }
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKBeaconXDButton", @"MKBXDScanController", @"bxd_about_logo.png");
    }
    return _aboutIcon;
}
...
- (UILabel *)versionLabel{
    if (!_versionLabel) {
        ...
        _versionLabel.text = @"Version: V2.1.3";
    }
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKBeaconXDButton", @"MKBXDScanController", @"bxd_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
