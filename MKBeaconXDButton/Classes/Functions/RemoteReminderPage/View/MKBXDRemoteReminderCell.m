...
@implementation MKBXDRemoteReminderCellModel
@end

@interface MKBXDRemoteReminderCell ()
...
@implementation MKBXDRemoteReminderCell

+ (MKBXDRemoteReminderCell *)initCellWithTableView:(UITableView *)tableView {
    MKBXDRemoteReminderCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBXDRemoteReminderCellIdenty"];
    if (!cell) {
        cell = [[MKBXDRemoteReminderCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBXDRemoteReminderCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKBXDRemoteReminderCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBXDRemoteReminderCellModel.class]) {
        return;
    }
