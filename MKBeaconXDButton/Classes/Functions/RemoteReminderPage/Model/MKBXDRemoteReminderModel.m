...
@interface MKBXDRemoteReminderModel ()
...
@implementation MKBXDRemoteReminderModel
...
- (BOOL)readLEDParams {
    ...
    [MKBXDInterface bxd_readRemoteReminderLEDNotiParamsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBuzzerParams {
    __block BOOL success = NO;
    [MKBXDInterface bxd_readRemoteReminderBuzzerNotiParamsWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
