...
@interface MKBXDDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKBXDDFUModule

- (void)dealloc{
    NSLog(@"MKBXDDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBXDCentralManager shared].peripheral];
}
