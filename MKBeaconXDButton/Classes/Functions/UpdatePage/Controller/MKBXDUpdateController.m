//
//  MKBXDUpdateController.m
//  MKLoRaWAN-bxd_Example
//
...
@property (nonatomic, strong)MKBXDDFUModule *dfuModule;
...
@implementation MKBXDUpdateController

- (void)dealloc {
    NSLog(@"MKBXDUpdateController销毁");
...
- (void)updateComplete {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxd_centralDeallocNotification" object:nil];
