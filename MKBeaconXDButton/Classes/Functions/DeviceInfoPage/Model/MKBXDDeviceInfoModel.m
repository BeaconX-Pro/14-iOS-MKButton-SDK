...
@implementation MKBXDDeviceInfoModel
...
- (BOOL)readMacAddress {
    ...
    [MKBXDInterface bxd_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBatteryVoltage {
    __block BOOL success = NO;
    [MKBXDInterface bxd_readBatteryVoltageWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKBXDInterface bxd_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKBXDInterface bxd_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKBXDInterface bxd_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKBXDInterface bxd_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
